...
function onClickLocation(control) {
    ...
    confirm = function() {
        ...
        window.JSInterface.customLocationInitialized(customLocation.getLatLng().lat, customLocation.getLatLng().lng, userIcon.heading);
...
function onClickHeading(control) {
    ...
    confirm = function() {
        window.JSInterface.customLocationInitialized(user.getLatLng().lat, user.getLatLng().lng, customRotationIcon.heading);
        clean();
    };
